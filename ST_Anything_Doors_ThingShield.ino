...
//Garage Door Pins 
#define PIN_RELAY_GARAGE_DOOR_1      4
#define PIN_RELAY_GARAGE_DOOR_2      5
#define PIN_RELAY_GARAGE_DOOR_3      6
#define PIN_CONTACT_GARAGE_DOOR_1    7
#define PIN_CONTACT_GARAGE_DOOR_2    8
#define PIN_CONTACT_GARAGE_DOOR_3    9
...
//WiFiEsp Information
//****************************************************************************************** 
String str_ssid     = "B27C11_X2";                               //  <---You must edit this line!
String str_password = "modernpiano440  ";                        //  <---You must edit this line!
IPAddress ip(192, 168, 1, 225);       // Device IP Address       //  <---You must edit this line!
...
void setup()
{
  ...
  static st::IS_DoorControl sensor1(F("GarageDoor1"), PIN_CONTACT_GARAGE_DOOR_1, LOW, true, PIN_RELAY_GARAGE_DOOR_1, LOW, true, 1000);
  static st::IS_DoorControl sensor2(F("GarageDoor2"), PIN_CONTACT_GARAGE_DOOR_2, LOW, true, PIN_RELAY_GARAGE_DOOR_2, LOW, true, 1000);
  static st::IS_DoorControl sensor3(F("GarageDoor3"), PIN_CONTACT_GARAGE_DOOR_3, LOW, true, PIN_RELAY_GARAGE_DOOR_3, LOW, true, 1000);
  ...
  st::Everything::SmartThing = new st::SmartThingsWiFiEsp(&mySerial, str_ssid, str_password, ip, serverPort, hubIp, hubPort, st::receiveSmartString);

  //Initialize the SoftwareSerial baudrate to match your ESP-01's baud rate (e.g. 9600, 57600, 115200)
